      ...
      <main className="min-h-screen p-4 md:p-8 bg-background">
        <div className="max-w-4xl mx-auto">
          <div className="flex justify-between items-center mb-8">
            <div>
              <h1 className="text-3xl font-bold text-foreground">CronMaster</h1>
              <p className="text-muted-foreground">Generate cron expressions without memorizing syntax</p>
            </div>
            <ThemeToggle />
          </div>
          ...
          <Card className="mb-8 cursor-pointer">
            <CardHeader>
              ...
              <CardDescription>Create and test cron expressions with visual selectors</CardDescription>
            </CardHeader>
            <CardContent>
              {mode === "basic" ? (
                <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
                  <CronFieldSelector
                    ...
                    options={[
                      ...
                      { value: "0,30", label: "At minutes 0 and 30 (0,30)" },
                    ]}
                ...
                <div className="space-y-4">
                  <div>
                    <Label htmlFor="advanced-expression">Cron Expression</Label>
                      ...
                      <Dialog>
                        ...
                        <DialogContent>
                          ...
                          <div className="mt-4 space-y-2">
                            ...
                            <p>
                              <span className="font-mono">*/n</span> - every n values
                            </p>
                            <p>
                              <span className="font-mono">n-m</span> - range from n to m
                            </p>
                            <p>
                              <span className="font-mono">n,m</span> - specific values n and m
                            </p>
                          </div>
                        </DialogContent>
                      </Dialog>
                ...
                <div className="flex flex-col md:flex-row md:items-center gap-4">
                  <div className="flex-1">
                    ...
                    <div className="flex items-center mt-1 gap-2">
                      <code className="flex-1 bg-muted p-2 rounded-md font-mono text-lg">{cronExpression}</code>
                      <Button
                        variant="outline"
                        size="icon"
                  ...
                  <div className="flex-1">
                    ...
                    <div className="bg-muted p-2 rounded-md mt-1 min-h-[40px]">{cronDescription}</div>
                  </div>
                </div>
          ...
          <Collapsible open={isCheatsheetOpen} onOpenChange={setIsCheatsheetOpen} className="mb-8 border rounded-lg">
            <div className="flex items-center justify-between p-4">
              <h2 className="text-xl font-semibold">Cron Cheatsheet</h2>
              <CollapsibleTrigger asChild>
                <Button variant="ghost" size="sm">
                  <ChevronDown
                    className={cn("h-4 w-4 transition-transform duration-200", isCheatsheetOpen ? "rotate-180" : "")}
                  />
                  ...
                  <table className="w-full border-collapse">
                    ...
                    <tbody>
                      ...
                      <tr className="border-b">
                        ...
                        <td className="p-2">Every 5 minutes, 9AM-5PM, weekdays</td>
                        <td className="p-2">9:00, 9:05, 9:10, ... (Mon-Fri)</td>
                      </tr>
                      <tr className="border-b">
                        <td className="p-2 font-mono">0 0 1,15 * *</td>
                        <td className="p-2">Midnight on 1st and 15th of month</td>
                  ...
                  <Dialog>
                    ...
                    <DialogContent className="max-w-3xl">
                      <DialogHeader>
                        ...
                        <DialogDescription>A comprehensive guide to cron syntax and usage</DialogDescription>
                      </DialogHeader>
                      <div className="space-y-4 max-h-[60vh] overflow-y-auto pr-2">
                        <div>
                          <h3 className="text-lg font-medium">Basic Format</h3>
                          <p className="mt-1">A cron expression consists of 5 fields separated by spaces:</p>
                          <pre className="bg-muted p-2 rounded-md mt-2 font-mono overflow-x-auto">
                            ┌───────────── minute (0 - 59) │ ┌───────────── hour (0 - 23) │ │ ┌───────────── day of the
                            month (1 - 31) │ │ │ ┌───────────── month (1 - 12) │ │ │ │ ┌───────────── day of the week (0
                            - 6) (Sunday to Saturday) │ │ │ │ │ * * * * *
                          </pre>
                        </div>
                        ...
                        <div>
                          ...
                          <ul className="list-disc pl-5 mt-1 space-y-1">
                            ...
                            <li>
                              <span className="font-mono">,</span> - value list separator
                            </li>
                            <li>
                              <span className="font-mono">-</span> - range of values
                            </li>
                            <li>
                              <span className="font-mono">/</span> - step values
                            </li>
                          </ul>
                        </div>
                        ...
                        <div>
                          ...
                          <div className="space-y-2 mt-1">
                            <div>
                              ...
                              <p className="text-muted-foreground">Run once a day at midnight</p>
                            </div>
                            <div>
                              <p className="font-mono">*/15 * * * *</p>
                              <p className="text-muted-foreground">Run every 15 minutes</p>
                            </div>
                            <div>
                              <p className="font-mono">0 9 * * 1</p>
                              <p className="text-muted-foreground">Run at 9:00 AM every Monday</p>
                            </div>
                            <div>
                              <p className="font-mono">0 0 1 */3 *</p>
                              <p className="text-muted-foreground">
                                Run at midnight on the first day of every third month
                              </p>
                            </div>
                          </div>
                        </div>
                        ...
                        <div>
                          <h3 className="text-lg font-medium">Special Expressions</h3>
                          <div className="space-y-2 mt-1">
                            <div>
                              <p className="font-mono">@yearly (or @annually)</p>
                              <p className="text-muted-foreground">
                            ...
                            <div>
                              ...
                              <p className="text-muted-foreground">Run once a week at midnight on Sunday (0 0 * * 0)</p>
                            </div>
                            <div>
                              <p className="font-mono">@daily (or @midnight)</p>
                              <p className="text-muted-foreground">Run once a day at midnight (0 0 * * *)</p>
                            </div>
                            <div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Designed for developers who need to create cron expressions quickly and accurately
              </CardDescription>
            </CardHeader>
            <CardContent className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Create complex cron expressions without memorizing syntax using our intuitive visual interface
                </p>
              </div>
              <div className="space-y-2">
                <h3 className="font-medium">Instant Validation</h3>
                <p className="text-sm text-muted-foreground">
                  See the next execution times immediately to verify your expression works as expected
                </p>
              </div>
              <div className="space-y-2">
                <h3 className="font-medium">Developer-Friendly</h3>
                <p className="text-sm text-muted-foreground">
                  Built by developers for developers with a clean, efficient interface and helpful documentation
                </p>
              </div>
            </CardContent>
            <CardFooter className="flex justify-between">
              <div className="text-sm text-muted-foreground">
                <span className="font-medium">Pro Features</span> include saved expressions, validation, and API access
              </div>
              <Button variant="outline">Upgrade to Pro $5/month</Button>
            </CardFooter>
          </Card>
        </div>
      </main>
...
function CronFieldSelector({ label, value, onChange, options, tooltip }: CronFieldSelectorProps) {
  return (
